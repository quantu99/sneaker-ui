...
function ExtraLargeItems({ product, handleAddProducts, handleAddWishProducts }) {
...
function ExtraLarge({ cartItems, handleAddProducts, wishItems, handleAddWishProducts, productItems }) {
                            ...
                            <ul>
                                ...
                                <li className={cx('brand')}>
                                    <Link className={cx('checkbox')} to={'/sneakers/extra-large'}>
                                        <FontAwesomeIcon className={cx('square', 'xl')} icon={faSquare} />

                                        <FontAwesomeIcon
                                            className={cx('square-check', 'xl-check')}
                                            icon={faSquareCheck}
                                        />
                                    </Link>
                                    &#62; 45(US: &#62; 11.5)
