...
function LessThanOneItems({ product, handleAddProducts, handleAddWishProducts }) {
...
function lessThanOne({ cartItems, handleAddProducts, wishItems, handleAddWishProducts, productItems }) {
