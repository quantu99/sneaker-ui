...
function OneToThreeItems({ product, handleAddProducts, handleAddWishProducts }) {
...
function OneToThree({ cartItems, handleAddProducts, wishItems, handleAddWishProducts, productItems }) {
    ...
    useEffect(() => {
        const products = productItems.filter((products) => {
            return products.price > 1000000 && products.price <= 3000000;
        });
        setPrice(products);
    }, []);
    return (
                        ...
                        <ul>
                            ...
                            <li className={cx('brand')}>
                                <Link className={cx('checkbox')} to={'/sneakers/1000001-3000000'}>
                                    <FontAwesomeIcon className={cx('square', 'one-to-three')} icon={faSquare} />

                                    <FontAwesomeIcon
                                        className={cx('square-check', 'one-to-three-check')}
                                        icon={faSquareCheck}
                                    />
                                </Link>
