...
function ThreeToFiveItems({ product, handleAddProducts, handleAddWishProducts }) {
...
function ThreeToFive({ cartItems, handleAddProducts, wishItems, handleAddWishProducts, productItems }) {
    ...
    useEffect(() => {
        const products = productItems.filter((products) => {
            return products.price > 3000000 && products.price <= 5000000;
        });
        setPrice(products);
    }, []);
    return (
                        ...
                        <ul>
                            ...
                            <li className={cx('brand')}>
                                <Link className={cx('checkbox')} to={'/sneakers/3000001-5000000'}>
                                    <FontAwesomeIcon className={cx('square', 'three-to-five')} icon={faSquare} />

                                    <FontAwesomeIcon
                                        className={cx('square-check', 'three-to-five-check')}
                                        icon={faSquareCheck}
                                    />
                                </Link>
