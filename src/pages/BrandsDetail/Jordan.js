...
function Jordan({ cartItems, handleAddProducts, wishItems, handleAddWishProducts }) {
    const [products, setProducts] = useState([]);
    useEffect(() => {
        fetch('http://localhost:3000/data?brand=jordan')
            .then((res) => res.json())
            .then((res) => {
                setProducts(res);
            });
    ...
    return (
        <div className={cx('wrapper')}>
            ...
            <div className={cx('header')}>
                ...
                <Link to={'/sneakers/jordan'} className={cx('header-product')}>
                    Jordan
                </Link>
            </div>
                        ...
                        <ul>
                            ...
                            <li className={cx('brand')}>
                                <Link className={cx('checkbox')} to={'/sneakers/jordan'}>
                                    <FontAwesomeIcon className={cx('square', 'jordan')} icon={faSquare} />

                                    <FontAwesomeIcon
                                        className={cx('square-check', 'jordan-check')}
                                        icon={faSquareCheck}
                                    />
                                </Link>
                                Jordan
